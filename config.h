...
static const Rule rules[] = {
    ...
    { "Deadbeef",                 NULL,       NULL,       1 << 1,       False,       -1 },
    { "URxvt",                    NULL,       NULL,       1 << 2,       False,       -1 },
    { "Apvlv",                    NULL,       NULL,       1 << 3,       False,       -1 },
...
static const Layout layouts[] = {
    /* symbol  useless gaps? arrange function */
    { "[M]",   False,        monocle }, /* first entry is default */
    { "[]=",   True,         tile },
...
static Key keys[] = {
    ...
    { MODKEY,                       XK_z,     mpdchange,       {.i = -1} },
    { MODKEY,                       XK_x,     mpdchange,       {.i = +1} },
